...
function InventoryCheck(GoodsID)
{
	var Count=$('#Count'+GoodsID).val();
	$.ajax({
		type: "POST",
		url: "/index.php?g=User&m=Maiduogoodsimport&a=getGoodsState",
		...
		success: function(data){
			switch(data.error_no)
			{
				...
				case '2':
					alert(data.error_msg);
					document.getElementById('ShelvesState'+data.goodsId).innerHTML=data.state;
				break;
				default :
				  break;
			}
