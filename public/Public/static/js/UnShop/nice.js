...
jQuery(document).ready(function(){
	jQuery(".re_box ul li").hover(function(){
		...
		jQuery(this).find("img").stop().animate({"width":"310px","height":"208px","margin":"-10px","overflow":"hidden"},"slow");
	},function(){
		jQuery(this).find(".hidebox").hide();
		jQuery(this).find("img").stop().animate({"width":"290px","height":"198px","margin":"0px","overflow":"hidden"},"slow");
	});
});
...
jQuery(document).ready(function(){
	jQuery(".box_b").hover(function(){
		jQuery(this).find(".hidebox").show();
		jQuery(this).find(".tpic_m img").stop().animate({"width":"324px","height":"228px","margin":"-10px","overflow":"hidden"},"slow");
	},function(){
		jQuery(this).find(".hidebox").hide();
		jQuery(this).find(".tpic_m img").stop().animate({"width":"304px","height":"208px","margin":"0px","overflow":"hidden"},"slow");
	});
});

jQuery(document).ready(function(){
	jQuery(".box_ss").hover(function(){
		jQuery(this).find(".hidebox").show();
		jQuery(this).find(".tpic_m img").stop().animate({"width":"304px","height":"208px","margin":"-10px","overflow":"hidden"},"slow");
	},function(){
		jQuery(this).find(".hidebox").hide();
		jQuery(this).find(".tpic_m img").stop().animate({"width":"283px","height":"194px","margin":"0px","overflow":"hidden"},"slow");
	});
});

jQuery(document).ready(function(){
	jQuery(".box_l").hover(function(){
